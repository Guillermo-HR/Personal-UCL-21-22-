...
textoComparacion0_2='Para las gráficas.- Minutos entre goles, Minutos entre asistencias, % de tiros sin dirección a portería, % de tiros bloqueados y Fuera de juego lo óptimo seria que el indicador del jugador este lo más posible hacia la izquierda.'
